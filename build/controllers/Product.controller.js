...
let ProductController = class ProductController {
    ...
    getProduct(getreq) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (product === null)
                throw new error_1.default(404, 'Product is not found');
            return product;
        });
    }
    saveProduct(product) {
    ...
    updateProduct(product) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (update_product === null)
                throw new error_1.default(400, 'Product is not updated');
